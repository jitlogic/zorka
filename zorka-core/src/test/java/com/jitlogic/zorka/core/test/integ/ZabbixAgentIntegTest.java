...
public class ZabbixAgentIntegTest {
    ...
    public void setUp() throws Exception {
        ...
        mbsRegistry.register("java", java.lang.management.ManagementFactory.getPlatformMBeanServer(), null);
        agent = new ZorkaBshAgent(Executors.newSingleThreadExecutor(), Executors.newSingleThreadExecutor(), 5000, config);
