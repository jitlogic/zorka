...
public class SpyLibFunctionsTest extends ZorkaFixture {
    ...
    public void testSpyInstrumentConvenienceFn1() {
        ...
        //assertEquals("E1", ((TimeDiffProcessor)sdef.getProcessors(SpyLib.ON_SUBMIT).get(0)).getStartSlot());
        //assertEquals("R1", ((TimeDiffProcessor)sdef.getProcessors(SpyLib.ON_SUBMIT).get(0)).getStopSlot());
        //assertEquals("S1", ((TimeDiffProcessor)sdef.getProcessors(SpyLib.ON_SUBMIT).get(0)).getResultSlot());
    }
