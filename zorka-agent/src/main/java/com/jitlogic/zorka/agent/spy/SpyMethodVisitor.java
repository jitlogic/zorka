...
public class SpyMethodVisitor extends MethodVisitor {
    ...
    private final static String SUBMIT_CLASS = "com/jitlogic/zorka/agent/spy/MainSubmitter";
    ...
    public void visitCode() {
        ...
        if (symbolRegistry != null) {
            log.debug(ZorkaLogger.ZSP_METHOD_DBG, "Will trace method: %s", methodName);
