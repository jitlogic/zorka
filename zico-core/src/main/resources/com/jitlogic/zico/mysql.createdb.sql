...
insert into USERS (USER_NAME,REAL_NAME,PASSWORD,FLAGS) values ('admin', 'Administrator', 'admin', 1);
...
INSERT INTO GROUPS VALUES (1,'VIEWER'),(2,'ADMIN');
